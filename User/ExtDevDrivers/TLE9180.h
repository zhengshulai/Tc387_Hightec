...
#define IFX_TLE9180_SPI_BUFFER_SIZE (\
    ...
    (4U) + \
	(sizeof(IfxTLE9180_readSCArtCommands)/sizeof(IfxTLE9180_SpiRx)) + \
	(4U) + \
	(sizeof(IfxTLE9180_readErrCommands)/sizeof(IfxTLE9180_SpiRx)))
...
IFX_EXTERN void IfxTLE9180_ClrErr(IfxTLE9180 *tle9180);
/******************************************************************************/
