...
/**
 * This function initialize the ADC Group2 Queue0 for the ADC current measurements
 * with below topology
 * Three phase current sense with (per phase) low-side shunt resistors.
...
/** /brief
 *
 * This function initialize the ADC Group2 Queue1 for the ADC Voltage measurement
 * with below topology
 * Three phase current sense with (per phase) low-side shunt resistors.
...
/** /brief
 *
 * This function initialize the ADC Group3 Queue0 for the ADC current measurements
 * with below topology
 * Three phase current sense with (per phase) low-side shunt resistors.
