...
const Os_TaskConfigType OsCfg_Task_OsHook_Init_Task_Core0 = 
{
	//.Thread
	{
		/*.ContextConfig           =*/&OsCfg_Hal_Context_OsHook_Init_Task_Core0,
		/*.Context                 =*/&OsCfg_Hal_Context_OsHook_Init_Task_Core0_Dyn,
		/*Stack                    =*/&OsCfg_Stack_OsCore0_Task_Prio300,
		/*Dyn                      =*/OS_TASK_CASTDYN_TASK_2_THREAD(OsCfg_Task_OsHook_Init_Task_Core0_Dyn),
		/*OwnerApplication         =*/&OsCfg_App_OsApplication_NonTrusted_Core0,
		/*Core                     =*/&OsCfg_Core_OsCore0,
		/*IntApiState              =*/&OsCfg_Core_OsCore0_Dyn.IntApiState,
		/*TimerPortConfig          =*/NULL_PTR,
		...
		/*AccessRights             =*/&OsCfg_AccessCheck_NoAccess,
		/*Trace                    =*/NULL_PTR,
		/*FpuContext               =*/&OsCfg_Hal_FpuContext_OsHook_Init_Task_Core0_Dyn,
		/*InitialCallContext       =*/OS_CALLCONTEXT_TASK,
		/*PreThreadHook            =*/Os_TaskCallPreTaskHook,
		/*InitDuringStartUp        =*/TRUE,
		/*UsesFpu                  =*/TRUE
...
const Os_TaskConfigType OsCfg_Task_OsHook_Init_Task_Core1 = 
{
	//.Thread
	{
		/*.ContextConfig           =*/&OsCfg_Hal_Context_OsHook_Init_Task_Core1,
		/*.Context                 =*/&OsCfg_Hal_Context_OsHook_Init_Task_Core1_Dyn,
		/*Stack                    =*/&OsCfg_Stack_OsCore1_Task_Prio300,
		/*Dyn                      =*/OS_TASK_CASTDYN_TASK_2_THREAD(OsCfg_Task_OsHook_Init_Task_Core1_Dyn),
		/*OwnerApplication         =*/&OsCfg_App_OsApplication_NonTrusted_Core1,
		/*Core                     =*/&OsCfg_Core_OsCore1,
		/*IntApiState              =*/&OsCfg_Core_OsCore1_Dyn.IntApiState,
		/*TimerPortConfig          =*/NULL_PTR,
		...
		/*AccessRights             =*/&OsCfg_AccessCheck_NoAccess,
		/*Trace                    =*/NULL_PTR,
		/*FpuContext               =*/&OsCfg_Hal_FpuContext_OsHook_Init_Task_Core1_Dyn,
		/*InitialCallContext       =*/OS_CALLCONTEXT_TASK,
		/*PreThreadHook            =*/Os_TaskCallPreTaskHook,
		/*InitDuringStartUp        =*/TRUE,
		/*UsesFpu                  =*/TRUE
...
const Os_TaskConfigType OsCfg_Task_OsHook_Init_Task_Core2 = 
{
	//.Thread
	{
		/*.ContextConfig           =*/&OsCfg_Hal_Context_OsHook_Init_Task_Core2,
		/*.Context                 =*/&OsCfg_Hal_Context_OsHook_Init_Task_Core2_Dyn,
		/*Stack                    =*/&OsCfg_Stack_OsCore2_Task_Prio300,
		/*Dyn                      =*/OS_TASK_CASTDYN_TASK_2_THREAD(OsCfg_Task_OsHook_Init_Task_Core2_Dyn),
		/*OwnerApplication         =*/&OsCfg_App_OsApplication_NonTrusted_Core2,
		/*Core                     =*/&OsCfg_Core_OsCore2,
		/*IntApiState              =*/&OsCfg_Core_OsCore2_Dyn.IntApiState,
		/*TimerPortConfig          =*/NULL_PTR,
		...
		/*AccessRights             =*/&OsCfg_AccessCheck_NoAccess,
		/*Trace                    =*/NULL_PTR,
		/*FpuContext               =*/&OsCfg_Hal_FpuContext_OsHook_Init_Task_Core2_Dyn,
		/*InitialCallContext       =*/OS_CALLCONTEXT_TASK,
		/*PreThreadHook            =*/Os_TaskCallPreTaskHook,
		/*InitDuringStartUp        =*/TRUE,
		/*UsesFpu                  =*/TRUE
...
const Os_TaskConfigType OsCfg_Task_OsHook_Init_Task_Core3 = 
{
	//.Thread
	{
		/*.ContextConfig           =*/&OsCfg_Hal_Context_OsHook_Init_Task_Core3,
		/*.Context                 =*/&OsCfg_Hal_Context_OsHook_Init_Task_Core3_Dyn,
		/*Stack                    =*/&OsCfg_Stack_OsCore3_Task_Prio300,
		/*Dyn                      =*/OS_TASK_CASTDYN_TASK_2_THREAD(OsCfg_Task_OsHook_Init_Task_Core3_Dyn),
		/*OwnerApplication         =*/&OsCfg_App_OsApplication_NonTrusted_Core3,
		/*Core                     =*/&OsCfg_Core_OsCore3,
		/*IntApiState              =*/&OsCfg_Core_OsCore3_Dyn.IntApiState,
		/*TimerPortConfig          =*/NULL_PTR,
		...
		/*AccessRights             =*/&OsCfg_AccessCheck_NoAccess,
		/*Trace                    =*/NULL_PTR,
		/*FpuContext               =*/&OsCfg_Hal_FpuContext_OsHook_Init_Task_Core3_Dyn,
		/*InitialCallContext       =*/OS_CALLCONTEXT_TASK,
		/*PreThreadHook            =*/Os_TaskCallPreTaskHook,
		/*InitDuringStartUp        =*/TRUE,
		/*UsesFpu                  =*/TRUE
